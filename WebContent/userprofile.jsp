				...
				<div class="col-lg-4  div000" style="background-color:;">
					<blockquote>
						...
						<%try{
							...
							Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/hms00","root","");
								Statement st=cn.createStatement();
								ResultSet rs=st.executeQuery("select * from reg00 where email='"+email+"' and status='requestSent'");
								while(rs.next()){
